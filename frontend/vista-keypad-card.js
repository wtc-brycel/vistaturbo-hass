const VISTA_KEYPAD_CARD_VERSION = "0.3.2";
...
class VistaKeypadCard extends HTMLElement {
    ...
    return `<div class="status-cr2">
      ...
      <div class="fire-panel">
        <div class="fire-rows">
          ...
          ${this._led("FIRE TROUBLE", display.fireTrouble, "fire-trouble")}
        </div>
  ...
  _styles() {
    ...
    return `
      ...
      .cr2 .controls-well::before {
        background:linear-gradient(180deg,#d9232a,#cb171f);
        box-shadow:
          inset .22cqw .18cqw .22cqw rgba(255,255,255,.16),
          inset -.2cqw -.18cqw .22cqw rgba(74,0,0,.19),
          0 .06cqw .08cqw rgba(0,0,0,.12);
      }

      .k6160 .controls-well::before {
        background:linear-gradient(180deg,#f8f8f5,#e1e1dc);
        box-shadow:
          inset .22cqw .18cqw .22cqw rgba(255,255,255,.88),
          inset -.18cqw -.16cqw .22cqw rgba(70,70,65,.10),
          0 .06cqw .08cqw rgba(0,0,0,.08);
      }
      ...
      .physical-key {
        ...
        box-shadow:
          0 .35cqw .25cqw rgba(0,0,0,.27),
          inset 0 .16cqw .13cqw rgba(255,255,255,.98),
          inset 0 -.16cqw .17cqw rgba(0,0,0,.13),
          inset .12cqw 0 .12cqw rgba(255,255,255,.55);
        cursor:pointer;
        touch-action:manipulation;
        transition:transform .045s ease, box-shadow .045s ease, filter .08s ease;
      ...
      .physical-key.pressed {
        ...
        box-shadow:
          0 .07cqw .08cqw rgba(0,0,0,.27),
          inset 0 .19cqw .21cqw rgba(0,0,0,.15);
      ...
      .led {
        ...
        background:
          radial-gradient(ellipse at 36% 22%,rgba(255,255,255,.18) 0 8%,transparent 27%),
          linear-gradient(180deg,#5a5954 0%,#393935 43%,#252622 100%);
        box-shadow:
          inset .17cqw .14cqw .23cqw rgba(0,0,0,.80),
          inset -.10cqw -.07cqw .12cqw rgba(255,255,255,.12),
          0 .06cqw .08cqw rgba(255,255,255,.13),
          0 -.055cqw .07cqw rgba(0,0,0,.40);
      }
      ...
      .led.on {
        background:
          radial-gradient(ellipse at 34% 24%,#f8ffd5 0 8%,#e0ff7d 15%,rgba(224,255,125,.34) 27%,transparent 39%),
          radial-gradient(ellipse at 51% 55%,#c0ef47 0%,#95ca34 55%,#5d841e 83%,#354a12 100%);
        border-color:rgba(66,94,19,.78);
        box-shadow:
          0 0 .18cqw rgba(205,250,87,.98),
          0 0 .62cqw rgba(163,226,53,.84),
          0 0 1.18cqw rgba(139,201,39,.20),
          inset .08cqw .07cqw .14cqw rgba(255,255,255,.80),
          inset -.12cqw -.1cqw .14cqw rgba(47,74,10,.42),
          0 -.045cqw .06cqw rgba(0,0,0,.34);
      }

      .led.on::before {
        background:linear-gradient(155deg,rgba(255,255,255,.82),rgba(255,255,255,.08) 46%,transparent 62%);
        opacity:.9;
      }

      .led.on::after {
        background:radial-gradient(ellipse,rgba(255,255,255,.98),rgba(255,255,255,.28) 42%,transparent 74%);
        opacity:.92;
      }
