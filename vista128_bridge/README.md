...
The App also publishes four count sensors with matching-zone details in their attributes:
...
RF low-battery and sensor-tamper events are not part of the `49ZS` snapshot and are not presented as equivalent persistent zone-condition entities.
