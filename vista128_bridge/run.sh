...
export MQTT_OUTBOUND_QUEUE_MAX="$(config_or_default 'mqtt_outbound_queue_max' '256')"
export MQTT_INFLIGHT_MESSAGES_MAX="$(config_or_default 'mqtt_inflight_messages_max' '20')"
...
export TX_QUEUE_MAX="$(config_or_default 'tx_queue_max' '128')"
export RAW_TX_QUEUE_MAX="$(config_or_default 'raw_tx_queue_max' '16')"
...
export KEYPAD_AUDIT_ENABLED="$(config_or_default 'keypad_audit_enabled' 'true')"
export EVENT_HISTORY_MAX_AGE_DAYS="$(config_or_default 'event_history_max_age_days' '90')"
export EVENT_HISTORY_MAX_ROWS="$(config_or_default 'event_history_max_rows' '10000')"
